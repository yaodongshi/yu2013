#!/bin/bash
################################################################################
# Script for installing Odoo V12 on Ubuntu 16.04, 15.04, 14.04 (could be used for other version too)
...
sudo pip3 install gdata psycogreen ofxparse XlsxWriter xlrd
